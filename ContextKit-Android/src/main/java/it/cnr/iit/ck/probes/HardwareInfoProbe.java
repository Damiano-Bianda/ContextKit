...
class HardwareInfoProbe extends ContinuousProbe {
    ...
    public void init() {
        ...
        getContext().registerReceiver(wifiReceiver, intentFilter, null, getHandler());
    }
    ...
    public String[] getLogFileHeaders() {
        return getContext().getResources().getStringArray(R.array.hardware_info_log_file_headers);
    }
