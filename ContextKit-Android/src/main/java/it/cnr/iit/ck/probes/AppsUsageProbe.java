...
import it.cnr.iit.ck.model.AppUsageData;
...
class AppsUsageProbe extends ContinuousProbe {
    ...
    public String[] getLogFileHeaders() {
        return getContext().getResources().getStringArray(R.array.apps_usage_log_file_headers);
    }
    ...
    private void getRunningApps(){
        AppUsageData appUsageData = new AppUsageData(AppsUsageController.getAppUsageStats(getContext(), startDate));
        logOnFile(true, appUsageData);
    }
