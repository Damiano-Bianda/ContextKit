...
public class Sms implements Loggable{
    ...
    public Sms(Context context, me.everything.providers.android.telephony.Sms sms, boolean sent){
        ...
        this.timestamp = sms.receivedDate;
        this.sent = sent;
        this.body = sms.body;
    ...
    public String getRowToLog() {
        return timestamp + FileLogger.SEP + Utils.formatStringForCSV(address) + FileLogger.SEP +
                sent + FileLogger.SEP + containsUrl + FileLogger.SEP + fromAddressBook;
    }
}
