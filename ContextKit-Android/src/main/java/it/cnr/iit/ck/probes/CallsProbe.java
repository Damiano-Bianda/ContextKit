...
class CallsProbe extends OnEventProbe {
    ...
    private BroadcastReceiver callsReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getAction() != null){
                ...
                if(phoneNumber != null) {
                    onNewCall(phoneNumber, incoming);
                }
    ...
    public void init() {
        ...
        getContext().registerReceiver(callsReceiver, intentFilter, null, getHandler());
    ...
    @Override
    void onStop() {
        getContext().unregisterReceiver(callsReceiver);
    }
    ...
    public String[] getLogFileHeaders() {
        return getContext().getResources().getStringArray(R.array.calls_log_file_headers);
    }
