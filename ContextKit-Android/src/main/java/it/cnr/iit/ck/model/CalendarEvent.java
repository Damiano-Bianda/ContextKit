...
public class CalendarEvent implements Loggable{
    ...
    public String getRowToLog() {
        return Utils.formatStringForCSV(calendarName) + FileLogger.SEP + allDay + FileLogger.SEP + start + FileLogger.SEP +
                end + FileLogger.SEP + Utils.formatStringForCSV(title) + FileLogger.SEP + Utils.formatStringForCSV(location);
    }
}